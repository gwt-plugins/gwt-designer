...
public final class CompilingClassLoader extends ClassLoader implements
  ...
  @SuppressWarnings("unchecked")
  private final Map<Long, Object> weakJsoCache = new ReferenceMap(
  ...
  protected synchronized Class<?> findClass(String className)
    ...
    // TODO: Instantiations: probably should load via our parent ClassLoader? 
    // see http://google-web-toolkit.googlecode.com/svn/javadoc/2.0/com/google/gwt/core/client/GwtScriptOnly.html
