...
public abstract class CompilationUnitBuilder {
  ...
  // >>> XXX Instantiations
  static class CachedResourceCompilationUnitBuilder extends ResourceCompilationUnitBuilder {

	public CachedResourceCompilationUnitBuilder(String typeName, Resource resource) {
	  super(typeName, resource);
	}
	@Override
	protected CompilationUnit makeUnit(List<CompiledClass> compiledClasses,
			Set<ContentId> dependencies,
		...
		SourceFileCompilationUnit unit = (SourceFileCompilationUnit) super.makeUnit(compiledClasses, dependencies, jsniMethods, methodArgs, problems);
		// store data in disk cache
		CompilationUnitDiskCache.get().put(unit);
		return unit;
	}
  }
  // >>> XXX Instantiations
