...
#ifndef nsIScriptContext1713_h__
#define nsIScriptContext1713_h__
...
class nsIScriptGlobalObject1713;
...
#define NS_ISCRIPTCONTEXT_1713_IID \
 ...
 * language neutral</I>
 */
class nsIScriptContext1713 : public nsISupports
{
public:
//  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTCONTEXT_1713_IID)
   ...
   *
   **/
  virtual nsIScriptGlobalObject1713 *GetGlobalObject() = 0;
   ...
   *
   **/
  virtual nsresult InitContext(nsIScriptGlobalObject1713 *aGlobalObject) = 0;
...
GetScriptContextFromJSContext(JSContext *cx)
{
  ...
  nsCOMPtr<nsIScriptContext1713> scx =
...
#endif // nsIScriptContext1713_h__
