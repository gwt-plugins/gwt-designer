...
public class LowLevelMoz64 extends LowLevelMoz {
	  /**
	   * Provides interface for methods to be exposed on JavaScript side.
	   */
	  public interface DispatchMethod64 {
	    /**
	     ...
	     *          value
	     */
	    void invoke(long jsthis, long []jsargs, long returnValue);
	  }

	  /**
	   * Provides interface for objects to be exposed to JavaScript code.
	   */
	  public interface DispatchObject64 {
	    /**
	     ...
	     */
	    void getField(String name, long value);
	   ...
	   */
	  public static void executeScriptWithInfo(long scriptObject, String code,
	  ...
	  public static long getScriptObjectProxy(long domWindow) {
		  return _getScriptObjectProxy(domWindow);
	  }
	  public static void releaseScriptObjectProxy(long domWindow) {
		  _releaseScriptObjectProxy(domWindow);
	  }
	  private static native long _getScriptObjectProxy(long domWindow);
	  private static native void _releaseScriptObjectProxy(long domWindow);
	  /**
	   ...
	   */
	  public static void invoke(long scriptObject, String methodName, long jsthis,
	      long[] jsargs, long retval) {
	...
	private static native boolean _executeScriptWithInfo(long scriptObject,
	 ...
	 */
	private static native boolean _invoke(long scriptObject, String methodName,
			long jsThisInt, long [] jsArgsInt, long jsRetValInt);
	 ...
	 */
	public static native long _makeShot(long windowHandle);
	/**
	 * Prepares the preview window to screen shot.
	 */
	public static native boolean _begin_shot(long windowHandle);
	/**
	 * Finalizes the process of screen shot.
	 */
	public static native boolean _end_shot(long windowHandle);
	/**
	 * Simply calls g_object_unref() for given <code>widgetHandle</code>.
	 */
	public static native void _g_object_unref(long widgetHandle);
}
