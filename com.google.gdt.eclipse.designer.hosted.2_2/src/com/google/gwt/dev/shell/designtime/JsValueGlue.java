...
public final class JsValueGlue {
  ...
  public static <T> T get(JsValue value, ClassLoader cl, Class<T> type, String msgPrefix) {
    if (type.isPrimitive()) {
      if (type == Boolean.TYPE) {
        ...
        return (T) Byte.valueOf((byte) getIntRange(
          value,
          Byte.MIN_VALUE,
          Byte.MAX_VALUE,
          "byte",
        ...
        return (T) Character.valueOf((char) getIntRange(
          value,
          Character.MIN_VALUE,
          Character.MAX_VALUE,
          "char",
        ...
        return (T) Integer.valueOf(getIntRange(
          value,
          Integer.MIN_VALUE,
          Integer.MAX_VALUE,
          "int",
        ...
        return (T) Short.valueOf((short) getIntRange(
          value,
          Short.MIN_VALUE,
          Short.MAX_VALUE,
          "short",
     ...
     */
    throw new IllegalArgumentException(msgPrefix
      + ": JS value of type "
      + value.getTypeString()
      + ", expected "
   ...
   */
  public static void set(JsValue value,
      ClassLoader cl,
      DispatchIdOracle dispIdOracle,
      Class<?> type,
      Object obj) {
    if (type.isPrimitive()) {
      if (type == Boolean.TYPE) {
      ...
      if (!type.isInstance(obj)) {
        throw new RuntimeException("object is of type "
