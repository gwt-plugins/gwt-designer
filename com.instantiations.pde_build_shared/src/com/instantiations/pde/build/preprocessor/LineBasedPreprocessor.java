...
{
	protected final Version eclipseTargetVersion;
	 ...
	 *            compiled (e.g. "3.3")
	 */
	protected LineBasedPreprocessor(Version eclipseTargetVersion) {
		this.eclipseTargetVersion = eclipseTargetVersion;
	}
	...
	/**
	 * Determine if backporting to the specified version of Eclipse
	 * 
	 * @param eclipseVersion the version of Eclipse (e.g. "3.2")
	 * @return <code>true</code> if backporting to at least the specified version of
	 *         Eclipse
	 */
	protected boolean backportTo(Version eclipseVersion) {
		return eclipseVersion.compareTo(eclipseTargetVersion) >= 0;
	}
