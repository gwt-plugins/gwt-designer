...
#ifndef nsIScriptContext2004_h__
#define nsIScriptContext2004_h__

#include "nscore.h"
#include "nsISupports.h"
#include "nsCOMPtr.h"

class nsIScriptGlobalObject2004;
...
#define NS_ISCRIPTCONTEXT_2004_IID \
 ...
 * language neutral</I>
 */
class nsIScriptContext2004 : public nsISupports
{
public:
//  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTCONTEXT_IID)
     static const nsIID& GetIID() {static const nsIID iid = NS_ISCRIPTCONTEXT_2004_IID; return iid;} 
   ...
   *
   **/
  virtual nsIScriptGlobalObject2004 *GetGlobalObject() = 0;
   ...
   *
   **/
  virtual nsresult InitContext(nsIScriptGlobalObject2004 *aGlobalObject) = 0;
...
GetScriptContextFromJSContext(JSContext *cx)
{
  ...
  nsCOMPtr<nsIScriptContext2004> scx =
...
#endif // nsIScriptContext2004_h__
