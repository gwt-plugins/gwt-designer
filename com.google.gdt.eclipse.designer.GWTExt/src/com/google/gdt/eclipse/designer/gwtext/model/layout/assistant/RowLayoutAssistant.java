...
/**
 * Assistant pages provider for {@link RowLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage GWTExt.model.layout.assistant
 */
public final class RowLayoutAssistant extends LayoutAssistantSupport<RowLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public RowLayoutAssistant(RowLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new RowLayoutDataAssistantPage(parent, objects);
  }
}