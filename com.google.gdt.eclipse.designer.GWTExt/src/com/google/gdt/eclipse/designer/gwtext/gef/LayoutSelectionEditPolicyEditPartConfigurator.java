...
public final class LayoutSelectionEditPolicyEditPartConfigurator implements IEditPartConfigurator {
  private static final String SELECTION_ID = "GWTExt.LayoutInfo.SelectionEditPolicy";
  ...
  public static class LayoutTracker {
    ...
    private void decorateChild(final EditPart child) {
      if (m_policyClass != null && child.getModel() instanceof WidgetInfo) {
    ...
    private String getSelectionClassName(LayoutInfo layout) {
      ...
      String prefix = "com.google.gdt.eclipse.designer.gwtext.model.layout.";
      ...
      return "com.google.gdt.eclipse.designer.gwtext.gef.policy."
          + layoutName
          + "SelectionEditPolicy";
    }
  }
