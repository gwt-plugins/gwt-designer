...
/**
 * Assistant pages provider for {@link FormLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage GWTExt.model.layout.assistant
 */
public final class FormLayoutAssistant extends LayoutAssistantSupport<FormLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public FormLayoutAssistant(FormLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createLayoutPage(Composite parent) {
    return new FormLayoutAssistantPage(parent, m_layout);
  }

  @Override
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new FormLayoutDataAssistantPage(parent, objects);
  }
}