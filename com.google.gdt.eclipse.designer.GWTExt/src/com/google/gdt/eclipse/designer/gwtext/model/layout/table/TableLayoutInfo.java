...
import com.google.gdt.eclipse.designer.gwtext.model.layout.assistant.TableLayoutAssistant;
...
/**
 * Model for <code>com.gwtext.client.widgets.layout.TableLayout</code>.
 * 
 * @author scheglov_ke
 * @coverage GWTExt.model.layout
 */
public final class TableLayoutInfo extends LayoutInfo {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ...
  private TableLayoutDataInfo m_removingTableData;
  ...
  protected void onWidgetRemoveAfter(WidgetInfo widget) throws Exception {
    ...
    if (m_replaceWithFillers && !isFiller(widget)) {
      ...
      {
        TableLayoutDataInfo tableData = m_removingTableData;
  ...
  protected Object getDefaultVirtualDataObject(WidgetInfo widget) throws Exception {
    ...
    return classLoader.loadClass("com.gwtext.client.widgets.layout.TableLayoutData").newInstance();
  }

  /**
   * @return {@link TableLayoutDataInfo} association with given {@link WidgetInfo}.
   */
  public static TableLayoutDataInfo getTableData(WidgetInfo widget) {
    return (TableLayoutDataInfo) getLayoutData(widget);
  }
   ...
   */
  void deleteEmptyColumnsRows(TableLayoutDataInfo removingData) throws Exception {
   ...
   */
  private void deleteEmptyColumns(TableLayoutDataInfo removingData) throws Exception {
   ...
   */
  private void deleteEmptyRows(TableLayoutDataInfo removingData) throws Exception {
    WidgetInfo[][] grid = getWidgetsGrid();
  ...
  private void fetchDimensions() throws Exception {
    boolean initializeData = m_columns.isEmpty();
    TableLayoutDimensionsSupport support = new TableLayoutDimensionsSupport(this, initializeData);
    support.initialize();
  ...
  boolean isEmptyColumn(final int column) {
    ...
    visitWidgets(new WidgetVisitor() {
      public void visit(WidgetInfo component, TableLayoutDataInfo cell) throws Exception {
        if (cell.x == column) {
  ...
  public static boolean isFiller(WidgetInfo widget) {
    return widget.getVariableSupport() instanceof EmptyVariableSupport
        && widget.getDescription().getComponentClass().getName().equals(
  ...
  private void addFiller(int column, int row) throws Exception {
    ...
    TableLayoutDataInfo tableData = getTableData(filler);
    tableData.x = column;
    tableData.y = row;
  }
  ...
  ////////////////////////////////////////////////////////////////////////////
  /**
   * Visitor for {@link WidgetInfo} and their {@link TableLayoutDataInfo}.
   */
  interface WidgetVisitor {
    void visit(WidgetInfo component, TableLayoutDataInfo constraints) throws Exception;
  }
  ...
  private void createGridInfo() throws Exception {
    ...
    m_gridInfo = new IGridInfo() {
      ...
      public IAbstractComponentInfo getOccupied(int column, int row) {
        for (WidgetInfo widget : getContainer().getChildrenWidgets()) {
          TableLayoutDataInfo data = getTableData(widget);
