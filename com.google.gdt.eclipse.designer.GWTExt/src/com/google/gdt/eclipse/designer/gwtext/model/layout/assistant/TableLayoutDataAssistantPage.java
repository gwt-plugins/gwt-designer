...
/**
 * Assistant for GWT-Ext {@link TableLayoutDataInfo}.
 * 
 * @author sablin_aa
 * @coverage GWTExt.model.layout.assistant
 */
public class TableLayoutDataAssistantPage extends LayoutDataAssistantPage {
  public TableLayoutDataAssistantPage(Composite parent, List<ObjectInfo> selection) {
    super(parent, selection);
    GridLayoutFactory.create(this).columns(2);
    addIntegerProperty(this, "colspan");
    addIntegerProperty(this, "rowspan");
  }
}