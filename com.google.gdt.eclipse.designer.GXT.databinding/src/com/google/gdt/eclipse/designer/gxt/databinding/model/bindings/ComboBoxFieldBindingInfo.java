 ...
 * 
 */
public class ComboBoxFieldBindingInfo extends FieldBindingInfo {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public ComboBoxFieldBindingInfo(ObserveInfo target,
      ObserveInfo targetProperty,
      String parsedProperty) {
    super(target, targetProperty, parsedProperty);
    m_baseClassName = "com.extjs.gxt.ui.client.binding.SimpleComboBoxFieldBinding";
  }
}