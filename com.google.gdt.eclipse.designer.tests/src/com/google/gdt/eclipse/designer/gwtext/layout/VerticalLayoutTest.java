...
/**
 * Tests for <code>VerticalLayout</code>.
 * 
 * @author scheglov_ke
 */
public class VerticalLayoutTest extends GwtExtModelTest {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Exit zone :-) XXX
  //
  ...
  public void test_parse() throws Exception {
    ...
    assertHierarchy(
        "{this: com.gwtext.client.widgets.Panel} {this} {/setLayout(new VerticalLayout())/ /add(label)/}",
        "  {new: com.gwtext.client.widgets.layout.VerticalLayout} {empty} {/setLayout(new VerticalLayout())/}",
