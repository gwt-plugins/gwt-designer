...
/**
 * Test for <code>EditorGrid</code>.
 * 
 * @author scheglov_ke
 */
public class EditorGridTest extends GxtModelTest {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Exit zone :-) XXX
  //
  ...
  public void test_CREATE() throws Exception {
    ...
    assertEditor(
        ...
        "  public Test() {",
        "    {",
        "      EditorGrid editorGrid = new EditorGrid(new ListStore(), new ColumnModel(Collections.<ColumnConfig>emptyList()));",
        "      add(editorGrid);",
