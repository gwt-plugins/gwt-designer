...
/**
 * Test for {@link HBoxLayoutInfo}.
 * 
 * @author scheglov_ke
 */
public class HBoxLayoutTest extends GxtModelTest {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Exit zone :-) XXX
  //
  ...
  public void test_setLayout() throws Exception {
    LayoutContainerInfo container =
        parseJavaInfo(
            ...
            "}");
    // set HBoxLayout
    HBoxLayoutInfo layout = createJavaInfo("com.extjs.gxt.ui.client.widget.layout.HBoxLayout");
    ...
    assertEditor(
        ...
        "}");
    assertHierarchy(
        "{this: com.extjs.gxt.ui.client.widget.LayoutContainer} {this} {/setLayout(new HBoxLayout())/}",
        "  {new: com.extjs.gxt.ui.client.widget.layout.HBoxLayout} {empty} {/setLayout(new HBoxLayout())/}");
  ...
  public void test_setMarginAll() throws Exception {
    ...
    assertEditor(
        ...
        "    {",
        "      Button button = new Button();",
        "      add(button, new HBoxLayoutData(10, 10, 10, 10));",
        "    }",
        "  }",
        "}");
    // set margin
