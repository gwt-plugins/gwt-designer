...
/**
 * {@link SelectionLayoutEditPolicy} for {@link HBoxLayoutInfo}.
 * 
 * @author scheglov_ke
 * @coverage ExtGWT.gef.policy
 */
public final class HBoxSelectionEditPolicy extends AbstractResizeSelectionEditPolicy {
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public HBoxSelectionEditPolicy(WidgetInfo widget) {
    m_widget = widget;
  }
  ...
  private void prepareNewFlex() {
    m_flex = HBoxLayoutInfo.getHBoxData(m_widget).getFlex();
    m_flex += m_sizeDelta.width / 50;
