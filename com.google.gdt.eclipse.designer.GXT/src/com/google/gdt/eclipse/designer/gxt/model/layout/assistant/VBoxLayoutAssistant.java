...
/**
 * Assistant pages provider for {@link VBoxLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class VBoxLayoutAssistant extends LayoutAssistantSupport<VBoxLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public VBoxLayoutAssistant(VBoxLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createLayoutPage(Composite parent) {
    return new VBoxLayoutAssistantPage(parent, m_layout);
  }

  @Override
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new VBoxLayoutDataAssistantPage(parent, objects);
  }
}