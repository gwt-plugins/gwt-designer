...
/**
 * Assistant for GXT <code>BorderLayout</code>.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class BorderLayoutAssistantPage extends AbstractExtGwtAssistantPage {
  public BorderLayoutAssistantPage(Composite parent, BorderLayoutInfo selection) {
    super(parent, selection);
    GridLayoutFactory.create(this).columns(2);
    {
      Group optionsGroup =
          addBooleanProperties(this, "Options", new String[][]{
              new String[]{"enableState", "enableState"},
