...
import com.google.gdt.eclipse.designer.gxt.model.layout.CardLayoutInfo;
...
/**
 * Assistant for GXT <code>CardLayout</code>.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class CardLayoutAssistantPage extends AbstractExtGwtAssistantPage {
    ...
    // options
    {
      Group optionsGroup =
          addBooleanProperties(this, "Options", new String[][]{
              new String[]{"deferredRender", "deferredRender"},
