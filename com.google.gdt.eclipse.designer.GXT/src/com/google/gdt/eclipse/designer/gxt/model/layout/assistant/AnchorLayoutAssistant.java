...
/**
 * Assistant pages provider for {@link AnchorLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class AnchorLayoutAssistant extends LayoutAssistantSupport<AnchorLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public AnchorLayoutAssistant(AnchorLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createLayoutPage(Composite parent) {
    return new AnchorLayoutAssistantPage(parent, m_layout);
  }

  @Override
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new AnchorLayoutDataAssistantPage(parent, objects);
  }
}