...
/**
 * Assistant pages provider for {@link FlowLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class FlowLayoutAssistant extends LayoutAssistantSupport<FlowLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public FlowLayoutAssistant(FlowLayoutInfo layout) {
    super(layout);
  }
