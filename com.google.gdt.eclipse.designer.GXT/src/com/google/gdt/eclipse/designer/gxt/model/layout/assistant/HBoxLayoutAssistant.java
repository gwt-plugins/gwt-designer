...
/**
 * Assistant pages provider for {@link HBoxLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class HBoxLayoutAssistant extends LayoutAssistantSupport<HBoxLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public HBoxLayoutAssistant(HBoxLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createLayoutPage(Composite parent) {
    return new HBoxLayoutAssistantPage(parent, m_layout);
  }

  @Override
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new HBoxLayoutDataAssistantPage(parent, objects);
  }
}