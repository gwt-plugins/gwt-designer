...
/**
 * Assistant pages provider for {@link ColumnLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class ColumnLayoutAssistant extends LayoutAssistantSupport<ColumnLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public ColumnLayoutAssistant(ColumnLayoutInfo layout) {
    super(layout);
  }
  ...
  protected AbstractAssistantPage createConstraintsPage(Composite parent, List<ObjectInfo> objects) {
    return new ColumnDataAssistantPage(parent, objects);
  }
}