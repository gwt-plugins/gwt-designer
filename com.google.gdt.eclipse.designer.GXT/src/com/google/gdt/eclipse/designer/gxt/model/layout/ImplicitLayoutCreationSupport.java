...
/**
 * {@link CreationSupport} for implicit {@link LayoutInfo}.
 * 
 * @author scheglov_ke
...
public final class ImplicitLayoutCreationSupport extends CreationSupport
  ...
  private final Object m_javaListener = new JavaInfoSetObjectAfter() {
    public void invoke(JavaInfo target, Object object) throws Exception {
      if (target == m_container) {
        Object layout = ReflectionUtils.invokeMethod(object, "getLayout()");
  ...
  private boolean useImplicitLayout() {
    return m_container.getArbitraryValue(LayoutContainerInfo.KEY_DONT_SET_IMPLICIT_LAYOUT) != Boolean.TRUE;
  }

  /**
   * @return <code>true</code> if given combination of parent/child is adding new {@link LayoutInfo}
   *         on our {@link LayoutContainerInfo}.
   */
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public ImplicitLayoutCreationSupport(LayoutContainerInfo container) {
  ...
  public String toString() {
    return "implicit-layout: " + ((LayoutInfo) m_javaInfo).getTitle();
  }
