...
/**
 * Assistant for GXT <code>HBoxLayoutData</code>.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class HBoxLayoutDataAssistantPage extends LayoutDataAssistantPage {
  public HBoxLayoutDataAssistantPage(Composite parent, List<ObjectInfo> selection) {
    ...
    GridLayoutFactory.create(this).columns(2);
    {
      ...
      {
        Group group =
            addIntegerProperties(composite, "Height", new String[][]{
                new String[]{"maxHeight", "max"},
                new String[]{"minHeight", "min"}});
