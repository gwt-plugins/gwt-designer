...
/**
 * Assistant pages provider for {@link AccordionLayoutInfo}.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class AccordionLayoutAssistant extends LayoutAssistantSupport<AccordionLayoutInfo> {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public AccordionLayoutAssistant(AccordionLayoutInfo accordionLayoutInfo,
  ...
  protected AbstractAssistantPage createLayoutPage(Composite parent) {
    return new AccordionLayoutAssistantPage(parent, m_layout);
  }
