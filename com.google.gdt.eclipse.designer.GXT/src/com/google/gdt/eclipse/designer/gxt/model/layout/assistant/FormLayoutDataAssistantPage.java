...
/**
 * Assistant for GXT <code>FormLayoutData</code>.
 * 
 * @author sablin_aa
 * @coverage ExtGWT.model.layout.assistant
 */
public final class FormLayoutDataAssistantPage extends LayoutDataAssistantPage {
  public FormLayoutDataAssistantPage(Composite parent, List<ObjectInfo> selection) {
    super(parent, selection);
    GridLayoutFactory.create(this).columns(2);
    // anchor
    addStringProperty(this, "anchorSpec", "anchorSpec");
    // margins
    {
    ...
    // size
    addIntegerProperty(this, "height", "height");
    addIntegerProperty(this, "width", "width");
  }
}