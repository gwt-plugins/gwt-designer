 ...
 * @coverage gwt.model
 */
public final class GenericWidgetConfigurator implements IJavaInfoInitializationParticipator {
  ////////////////////////////////////////////////////////////////////////////
  //
  ...
  public void process(JavaInfo javaInfo) throws Exception {
    if (javaInfo instanceof WidgetInfo) {
      WidgetInfo widget = (WidgetInfo) javaInfo;
      new UpdateSizeOnChildAddSupport(widget);
      new UpdateSizeOnChildOutSupport(widget);
    }
  }
}
