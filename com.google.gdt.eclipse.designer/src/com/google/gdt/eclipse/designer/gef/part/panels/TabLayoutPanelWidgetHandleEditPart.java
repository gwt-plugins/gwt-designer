...
/**
 * {@link EditPart} for {@link TabLayoutPanelInfo} header.
 * 
 * @author scheglov_ke
 * @coverage gwt.gef.part
 */
public final class TabLayoutPanelWidgetHandleEditPart extends AbstractWidgetHandleEditPart {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public TabLayoutPanelWidgetHandleEditPart(AbstractWidgetHandle<?> handle) {
    super(handle);
  }
