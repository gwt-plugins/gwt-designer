 ...
 */
public final class PopupPanelWizardPage extends GwtWizardPage {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ...
  public PopupPanelWizardPage() {
    setTitle("Create PopupPanel");
    setImageDescriptor(Activator.getImageDescriptor("wizards/PopupPanel/banner.gif"));
    setDescription("Create empty PopupPanel");
  }
  ...
  protected void createTypeMembers(IType newType, ImportsManager imports, IProgressMonitor monitor)
    ...
    InputStream stream = getTemplate("PopupPanel.jvt");
    try {
