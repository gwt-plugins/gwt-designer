 ...
 */
public final class DialogBoxWizardPage extends GwtWizardPage {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ...
  public DialogBoxWizardPage() {
    setTitle("Create DialogBox");
    setImageDescriptor(Activator.getImageDescriptor("wizards/DialogBox/banner.gif"));
    setDescription("Create empty DialogBox");
  }
  ...
  protected void createTypeMembers(IType newType, ImportsManager imports, IProgressMonitor monitor)
    ...
    InputStream stream = getTemplate("DialogBox.jvt");
    try {
